...
const highlights = [
  { label: 'OpenAPI spec', detail: 'Reference stays in lockstep with production', icon: <SparkleIcon /> },
  { label: 'TypeScript SDK', detail: 'Typed clients with request/response helpers', icon: <CodeIcon /> },
  { label: 'Sandbox fixtures', detail: 'Deterministic data for integration tests', icon: <ShieldIcon /> },
];
...
const steps: { title: string; detail: string; icon: React.ReactNode }[] = [
  { title: 'Create an API key', detail: 'Create an API key in sandbox.', icon: <KeyIcon /> },
  { title: 'Call payments and accounts', detail: 'Call payments and accounts endpoints with your credentials.', icon: <SendIcon /> },
  { title: 'Subscribe to webhooks', detail: 'Subscribe to webhooks and confirm signatures.', icon: <BellIcon /> },
  { title: 'Move to production', detail: 'Move to production with monitoring and alerting built in.', icon: <RocketIcon /> },
];
